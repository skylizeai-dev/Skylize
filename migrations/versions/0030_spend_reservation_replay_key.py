...
exactly why this migration could not be written before it. It chains onto 0029
(``ai_cost_ledger_correlation_index``) only because that revision claimed the
slot first; the substantive dependency is 0027, and 0029 is unrelated to spend
accounting.
...
def downgrade() -> None:
    ...
    # "return the original result" back to "re-execute". That is the pre-0030
