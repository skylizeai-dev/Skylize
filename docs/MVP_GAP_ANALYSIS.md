...
### 25. Agents with a proven full path to a persisted deliverable — **1 of 21**

**Proven, persisted to Postgres — 1:**
...
**Reach `create_deliverable` but against a mocked `DeliverableService` (nothing persists) — 2:**
- **`seo_keyword_agent`** — `tests/unit/test_seo_agent_execution.py:52-95` (`svc.create_deliverable = AsyncMock(...)` at `:57`).
