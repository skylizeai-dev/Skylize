...
## 1. Mission
Maintain the creative intelligence knowledge base of what works.

## 2. Responsibilities
- Aggregate winning patterns.
- Maintain pattern library.
- Serve recall to creative teams.
...
## 5. KPIs
Library quality; recall usefulness.

## 6. Inputs
`skylize.schemas.creative.CreativeIntelligenceAgentIn` — the scoped work item it consumes (validated against its contract `input_schema`).

## 7. Outputs
`skylize.schemas.creative.CreativeIntelligenceAgentOut` — its produced artifact, wrapped by the Orchestrator into the correct event.
...
## 10. Events Produced
- `memory.write_requested` (patterns)
...
**Read:** `creative:intelligence:*`. **Write:** `creative:intelligence:patterns`
