...
class RegisterRequest(BaseModel):
    ...
    def _validate_org_id(cls, value: str) -> str:
        # Fail closed: org_id becomes a tenant-isolation key, so it must be a
        # strict slug (no ':' or other separators that could forge a boundary).
        try:
            return validate_identifier(value, field="org_id")
